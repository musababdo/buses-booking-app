...
class _BodyState extends State<Body> {
  ...
  Future editUserProfile() async{
    ...
    try{
      var url = Uri.parse('http://10.0.2.2/busticket/profile/edit_user_profile.php');
  ...
  Future editPasswordProfile() async{
    ...
    try{
      var url = Uri.parse('http://10.0.2.2/busticket/profile/edit_password_profile.php');
      var response=await http.post(url, body: {
        'id'       : preferences.getString("id"),
  ...
  Future editPhoneProfile() async{
    ...
    try{
      var url = Uri.parse('http://10.0.2.2/busticket/profile/edit_phone_profile.php');
      var response=await http.post(url, body: {
        'id'    : preferences.getString("id"),
        'phone' : phone.text,
      });
  ...
  Future deleteProfile() async{
    ...
    var url = Uri.parse('http://10.0.2.2/busticket/profile/delete_profile.php');
    http.post(url,body: {
      'id' : preferences.getString("id"),
    });
    setState(() {
